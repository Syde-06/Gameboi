...
public static b4a.example.lbmanager _leaderboardmanager = null;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 9;BA.debugLine="Public leaderboardManager As LBManager";
_leaderboardmanager = new b4a.example.lbmanager();
 //BA.debugLineNum = 10;BA.debugLine="End Sub";
return "";
}
public static String  _service_create() throws Exception{
 //BA.debugLineNum = 12;BA.debugLine="Sub Service_Create";
 //BA.debugLineNum = 15;BA.debugLine="leaderboardManager.Initialize";
_leaderboardmanager._initialize /*String*/ (processBA);
