...
public class LS_spaceinvlayout{
...
views.get("lbllives").vw.setHeight((int)((50d * scale)));
((anywheresoftware.b4a.keywords.LayoutBuilder.DesignerTextSizeMethod)views.get("lbllives").vw).setTextSize((float)(12d));
views.get("lbllives").vw.setHeight((int)((50d * scale)));
((anywheresoftware.b4a.keywords.LayoutBuilder.DesignerTextSizeMethod)views.get("lbllives").vw).setTextSize((float)(12d));
...
views.get("lblscore").vw.setTop((int)(10d));
views.get("lbllives").vw.setTop((int)((views.get("lblscore").vw.getTop() + views.get("lblscore").vw.getHeight())));
views.get("lbllevel").vw.setTop((int)((views.get("lbllives").vw.getTop() + views.get("lbllives").vw.getHeight())));
views.get("pnlnextpiece").vw.setTop((int)((views.get("lbllevel").vw.getTop() + views.get("lbllevel").vw.getHeight())));
